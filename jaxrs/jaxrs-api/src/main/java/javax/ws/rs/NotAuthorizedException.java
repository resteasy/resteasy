...
public class NotAuthorizedException extends ClientErrorException {
     ...
     */
    public NotAuthorizedException(Response response) throws IllegalArgumentException {
     ...
     *                                  is not HTTP {@code 401}.
     */
    public NotAuthorizedException(Response response, Throwable cause) throws IllegalArgumentException {
