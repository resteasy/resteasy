...
public class TestValidationSurpressPathFalse extends TestValidationSuppressPathParent
{
   @Deployment
   public static Archive<?> createTestArchive()
   {
      WebArchive war = ShrinkWrap.create(WebArchive.class, "Validation-test.war")
            ...
            .setWebXML("web_suppress_false.xml")
   ...
   {
      doTestInputViolations("s", "t", "", "TestResourceWithAllViolationTypes#post(arg0)");
   }
   
   @Test
   public void testReturnValues() throws Exception
   {
      doTestReturnValueViolations("TestResourceWithReturnValues#postNative()");
   }
}
