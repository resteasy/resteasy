...
public class ResourceLocatorRegexCapturingGroupTest {
    ...
    public static Archive<?> deploy() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, ResourceLocatorRegexCapturingGroupTest.class.getSimpleName() + ".war");
    ...
    private String generateURL(String path) {
        String testName = ResourceLocatorRegexCapturingGroupTest.class.getSimpleName();
