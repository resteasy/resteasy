...
public class TestPathSuppression
{
   ...
   {
      doTestInputViolations(null, "s", "t", "", "TestResource#test(arg0)");
   }

   @Test
   public void testInputSuppressPathFalse() throws Exception
   {
      doTestInputViolations("false", "s", "t", "", "TestResource#test(arg0)");
   }
   ...
   {
      doTestReturnValueViolations(null, "TestResource#test()");
   }

   @Test
   public void testReturnValueSuppressPathFalse() throws Exception
   {
      doTestReturnValueViolations("false", "TestResource#test()");
   }
