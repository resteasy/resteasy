...
public class ObjectFactory
{
   ...
   private final static QName _DataCollectionPackage_QNAME = new QName("http://www.example.org/DataCollectionPackage", "DataCollectionPackage");
   private final static QName _DataCollectionRecord_QNAME = new QName("http://www.example.org/DataCollectionPackage", "DataCollectionRecord");
   private final static QName _SourceID_QNAME = new QName("http://www.example.org/DataCollectionPackage", "sourceID");
   private final static QName _Timestamp_QNAME = new QName("http://www.example.org/DataCollectionPackage", "timestamp");
   private final static QName _EventID_QNAME = new QName("http://www.example.org/DataCollectionPackage", "eventID");
   private final static QName _CollectedData_QNAME = new QName("http://www.example.org/DataCollectionPackage", "collectedData");
   ...
   /**
    * Create an instance of {@link JAXBElement }{@code <}{@link DataCollectionPackage }{@code >}}
    */
   @XmlElementDecl(namespace = "http://www.example.org/DataCollectionPackage", name = "DataCollectionPackage")
   public JAXBElement<DataCollectionPackage> createDataCollectionPackage(DataCollectionPackage value)
   {
      return new JAXBElement<DataCollectionPackage>(_DataCollectionPackage_QNAME, DataCollectionPackage.class, null, value);
   }

   /**
    * Create an instance of {@link JAXBElement }{@code <}{@link DataCollectionRecord }{@code >}}
    */
   ...
   {
      return new JAXBElement<DataCollectionRecord>(_DataCollectionRecord_QNAME, DataCollectionRecord.class, null, value);
   }
