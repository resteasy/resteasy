...
{
   private static boolean servletPresent;
   ...
   public void setOutputStreamWasWritten(boolean outputStreamWasWritten)
   {
   ...
   {
      return servletPresent ? new ContextServletOutputStream(this, os) : os;
   }
}
