...
{
   private ContextParameterInjector injector;
   private ServletOutputStream delegate;

   public ContextServletOutputStream(final ContextParameterInjector injector, final OutputStream delegate)
   {
   ...
   public void setInjector(ContextParameterInjector injector)
   {
      this.injector = injector;
   }
}
