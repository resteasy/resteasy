...
public abstract class AbstractCollectionFormInjector<T> extends PrefixedFormInjector {
     ...
     * @param prefix         prefix
     * @param pattern        The pattern that a field name should follow to be a part of this collection. The first group in the
     *                       pattern must be the index.
     * @param factory        provider factory
     */
    protected AbstractCollectionFormInjector(final Class collectionType, final Class genericType, final String prefix,
            final Pattern pattern, final ResteasyProviderFactory factory) {
