...
public class PortProvider
{
   ...
   {
      int port = -1;
      String property =  ResteasyConfig.instance.getOptionalValue(ENV_VAR_NAME, String.class).orElse(null);
      if (property != null)
      {
         try
         {
      ...
      if (port == -1)
      {
         property = ResteasyConfig.instance.getOptionalValue(PROPERTY_NAME, String.class).orElse(null);
         if (property != null)
         {
            try
            {
   ...
   {
      String host = null;
      String property = ResteasyConfig.instance.getOptionalValue(ENV_VAR_HOSTNAME, String.class).orElse(null);
      if (property != null)
      {
         host = property;
      }
      ...
      if (host == null)
      {
         property = ResteasyConfig.instance.getOptionalValue(PROPERTY_HOSTNAME, String.class).orElse(null);
         if (property != null)
         {
            host = property;
         }
