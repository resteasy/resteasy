...
public class XmlSupport {
    ...
    private static class XmlSecurityConfiguration {
        final boolean expandEntityReferences;
        final boolean enableSecureProcessingFeature;
        final boolean disableDTDs;

        XmlSecurityConfiguration(final boolean expandEntityReferences, final boolean enableSecureProcessingFeature,
                final boolean disableDTDs) {
