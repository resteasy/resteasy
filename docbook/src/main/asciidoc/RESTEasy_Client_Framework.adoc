...
For RESTEasy Jetty documentation, see https://docs.resteasy.dev/resteasy-jetty[docs.resteasy.dev/resteasy-jetty].
...
For RESTEasy Vert.x client documentation, see https://docs.resteasy.dev/resteasy-vertx[docs.resteasy.dev/resteasy-vertx].
