...
NOTE: This chapter documents the `resteasy-jackson2-provider` for Jackson 2. For Jackson 3 support, see the
standalone https://docs.resteasy.dev/resteasy-jackson-provider[RESTEasy Jackson Provider] project
(`dev.resteasy.providers:resteasy-jackson-provider`).
