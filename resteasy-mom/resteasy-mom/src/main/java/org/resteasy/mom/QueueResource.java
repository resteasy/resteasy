...
public class QueueResource
{
   ...
   @PUT
   @Path("/receivers/{id}")
   public Response createReceiver(@PathParam("id") String id) throws Exception
   {
      ...
      {
         Receiver receiver = new Receiver(destination, connection, processor);
   ...
   @PUT
   @Path("/listeners/{id}")
   public Response createListener(@PathParam("id") String id, String uri) throws Exception
   {
      ...
      {
         Listener listener = new Listener(destination, connection, uri, processor);
