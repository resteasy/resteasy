...
public class ResourceTest extends BaseResourceTest
{
   ...
   private static final String RFC_COMPLEX_XML =
           "   <atom:feed xmlns:atom=\"http://www.w3.org/2005/Atom\" xmlns:ns3=\"http://jboss.org/Customer\">\n" +
   ...
   public static void assertFeed(Feed feed) throws Exception
   {
      ...
      Assert.assertEquals(enclosure.getHref(), new URI("http://example.org/audio/ph34r_my_podcast.mp3"));
