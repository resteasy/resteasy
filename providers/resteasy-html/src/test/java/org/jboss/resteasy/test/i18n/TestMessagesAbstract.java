...
abstract public class TestMessagesAbstract extends TestMessagesParent
{
   ...
   {  
      ...
      String filename = "org/jboss/resteasy/providers/html/i18n/Messages.i18n_" + locale.toString() + ".properties";
      ...
      Assert.assertEquals(getExpected(BASE + "00", "noDispatcherFound", "xyz"), Messages.MESSAGES.noDispatcherFound("xyz"));
   }
