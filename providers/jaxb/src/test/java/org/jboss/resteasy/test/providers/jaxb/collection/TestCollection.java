...
public class TestCollection extends BaseResourceTest
{
   ...
   public void testArray() throws Exception
   {
      ...
      GetMethod get = new GetMethod("http://localhost:8081/array");
      int status = client.executeMethod(get);
      Assert.assertEquals(200, status);
      String str = get.getResponseBodyAsString();
      System.out.println(str);
      PutMethod put = new PutMethod("http://localhost:8081/array");
   ...
   {
      HttpClient client = new HttpClient();
      GetMethod get = new GetMethod("http://localhost:8081/list");
      int status = client.executeMethod(get);
      Assert.assertEquals(200, status);
      String str = get.getResponseBodyAsString();
      System.out.println(str);
      PutMethod put = new PutMethod("http://localhost:8081/list");
      put.setRequestEntity(new StringRequestEntity(str, "application/xml", null));
      status = client.executeMethod(put);
      Assert.assertEquals(200, status);
