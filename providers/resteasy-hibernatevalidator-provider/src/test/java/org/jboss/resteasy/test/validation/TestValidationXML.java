...
public class TestValidationXML
{
   ...
   protected void doTestXML_pre(String mediaType) throws Exception
   {
...

      {
         ...
         String parameterViolation = "<parameterViolations><constraintType>PARAMETER</constraintType><path>TestResourceWithAllFivePotentialViolations#post(arg0)</path><message>s must have length: 3 &lt;= length &lt;= 5</message><value>Foo[p]</value></parameterViolations>";
   ...
   protected void doTestXML_post(String mediaType) throws Exception
   {
...

      {
         ...
         String entity = response.getEntity(String.class);
         System.out.println("report: " + entity);
         String expected = "<violationReport><returnValueViolations><constraintType>RETURN_VALUE</constraintType><path>TestResourceWithAllFivePotentialViolations#post()</path><message>s must have length: 4 &lt;= length &lt;= 5</message><value>Foo[123]</value></returnValueViolations></violationReport>";
   ...
   protected void doTestJSON_pre(String mediaType) throws Exception
   {
...

      {
         ...
         String parameterViolation = "\"parameterViolations\":[{\"constraintType\":\"PARAMETER\",\"path\":\"TestResourceWithAllFivePotentialViolations#post(arg0)\",\"message\":\"s must have length: 3 <= length <= 5\",\"value\":\"Foo[p]\"}]";
   ...
   protected void doTestJSON_post(String mediaType) throws Exception
   {
...

      {
         ...
         String returnValueViolation = "\"returnValueViolations\":[{\"constraintType\":\"RETURN_VALUE\",\"path\":\"TestResourceWithAllFivePotentialViolations#post()\",\"message\":\"s must have length: 4 <= length <= 5\",\"value\":\"Foo[123]\"";
         Assert.assertTrue(entity.contains(start));
   ...
   protected void doTestText_pre(String mediaType) throws Exception
   {
      ...
      String parameterViolation =
            "[PARAMETER]\r" +
                  "[TestResourceWithAllFivePotentialViolations#post(arg0)]\r" +
   ...
   protected void doTestText_post(String mediaType) throws Exception
   {
      ...
      String returnValueViolation =
            "[RETURN_VALUE]\r" +
                  "[TestResourceWithAllFivePotentialViolations#post()]\r" +
