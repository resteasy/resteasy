...
//      HttpGet method = new HttpGet(TestPortProvider.generateURL("/HeadersTest/headers"));
//      method.addHeader("Accept", "text/plain, text/html, text/html;level=1, */*");
//      method.addHeader("Content-Type", "application/xml;charset=utf8");
