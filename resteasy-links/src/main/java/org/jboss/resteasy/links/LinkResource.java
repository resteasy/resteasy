...
public @interface LinkResource {
     ...
     * {@link javax.ws.rs.core.Response Response}.
     */
     ...
     * <dl>
     * <dt>list</dt>
     * <dd>{@link javax.ws.rs.GET GET} for {@link ResourceFacade} entities or methods that return a {@link java.util.Collection
     * Collection}</dd>
     * </dl>
     * <dl>
     * <dt>self</dt>
     * <dd>{@link javax.ws.rs.GET GET} for non-{@link ResourceFacade} and non-{@link java.util.Collection Collection}
     * entities</dd>
     * </dl>
     * <dl>
     * <dt>remove</dt>
