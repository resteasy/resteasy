 ...
 * @version $Revision: 1 $
 */
public class ThreadLocalResteasyProviderFactory extends org.jboss.resteasy.spi.old.ResteasyProviderFactory implements ProviderFactoryDelegate
{
   ...
   private org.jboss.resteasy.spi.old.ResteasyProviderFactory getOldDelegate() {
      return (org.jboss.resteasy.spi.old.ResteasyProviderFactory)getDelegate();
   }
   ...
   {
      return (ContainerResponseFilterRegistry)getOldDelegate().getContainerResponseFilterRegistry();
   }
   ...
   {
      return getOldDelegate().getClientExceptionMapper(type);
   }
   ...
   {
      getOldDelegate().addClientExceptionMapper(providerClass);
   }
   ...
   {
      getOldDelegate().addClientExceptionMapper(provider, exceptionType);
   }
   ...
   {
      getOldDelegate().addClientExceptionMapper(provider);
   }
   ...
   {
      getOldDelegate().addClientErrorInterceptor(handler);
   }
   ...
   {
      getOldDelegate().addClientExceptionMapper(provider, providerClass);
   }

   @Override
   public void insertInterceptorPrecedenceAfter(String after, String newPrecedence)
   {
      getOldDelegate().insertInterceptorPrecedenceAfter(after, newPrecedence);
   }
   ...
   {
      getOldDelegate().insertInterceptorPrecedenceBefore(before, newPrecedence);
   }
   ...
   {
      getOldDelegate().appendInterceptorPrecedence(precedence);
   }
