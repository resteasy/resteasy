package org.jboss.resteasy.test.resteasy1054;
...
import org.jboss.resteasy.resteasy1054.Foo;
import org.jboss.resteasy.resteasy1054.FooConstraint;
import org.jboss.resteasy.resteasy1054.FooReaderWriter;
import org.jboss.resteasy.resteasy1054.FooValidator;
import org.jboss.resteasy.resteasy1054.JaxRsActivator;
import org.jboss.resteasy.resteasy1054.TestClassConstraint;
import org.jboss.resteasy.resteasy1054.TestClassValidator;
import org.jboss.resteasy.resteasy1054.TestResourceWithAllViolationTypes;
import org.jboss.resteasy.resteasy1054.TestResourceWithReturnValues;
...
public class TestValidation
{
   ...
   public static Archive<?> createTestArchive()
   {
      WebArchive war = ShrinkWrap.create(WebArchive.class, "Validation-test.war")
            ...
            .addAsResource("1054/META-INF/services/javax.ws.rs.ext.Providers", "META-INF/services/javax.ws.rs.ext.Providers");
            ;
   ...
   public void testViolationsBeforeReturnValue() throws Exception
   {
      ...
      Assert.assertTrue(violation.getValue().startsWith("org.jboss.resteasy.resteasy1054.TestResourceWithAllViolationTypes@"));
