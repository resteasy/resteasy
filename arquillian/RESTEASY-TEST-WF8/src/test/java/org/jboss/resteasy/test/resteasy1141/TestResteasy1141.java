package org.jboss.resteasy.test.resteasy1141;

import org.jboss.arquillian.container.test.api.Deployment;
import org.jboss.arquillian.junit.Arquillian;
import org.jboss.resteasy.resteasy1141.TestApplication;
import org.jboss.resteasy.resteasy1141.TestResource;
...
public class TestResteasy1141 {
    ...
    public static Archive<?> createTestArchive() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "resteasy1141.war")
                ...
                .addAsWebInfResource("1141/web.xml");
