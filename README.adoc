...
A pull request labeled `requires-spec-snapshot` must not be merged until the Jakarta REST API it
needs is released and the label is removed. The usual builds are skipped
