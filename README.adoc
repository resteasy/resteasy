...
image:https://github.com/resteasy/resteasy/actions/workflows/maven.yml/badge.svg?branch=6.2[Github CI,link=https://github.com/resteasy/resteasy/actions/workflows/maven.yml?query=branch%3A6.2]
...
Currently, RESTEasy requires JDK 25+ to build. It compiles down to Java 11.
