...
image:https://github.com/resteasy/resteasy/actions/workflows/maven.yml/badge.svg?branch=7.0[Github CI,link=https://github.com/resteasy/resteasy/actions/workflows/maven.yml?query=branch%3A7.0]
