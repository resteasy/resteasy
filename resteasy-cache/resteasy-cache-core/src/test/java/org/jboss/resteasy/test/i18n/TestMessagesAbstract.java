...
abstract public class TestMessagesAbstract extends TestMessagesParent
{
   ...
   {  
      ...
      String filename = "org/jboss/resteasy/plugins/cache/i18n/Messages.i18n_" + locale.toString() + ".properties";
      ...
      Assert.assertEquals(getExpected(BASE + "00", "resteasyIsNotInitialized"), Messages.MESSAGES.resteasyIsNotInitialized());
   }
