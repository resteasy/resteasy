 ...
 *
 */
public class RestClientInjectionTarget<T> implements InjectionTarget<T>
{
   ...
   public RestClientInjectionTarget(final InjectionTarget<T> delegate, final Class<T> clazz)
   {
