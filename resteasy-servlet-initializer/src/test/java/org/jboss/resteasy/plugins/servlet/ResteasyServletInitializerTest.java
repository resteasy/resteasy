...
public class ResteasyServletInitializerTest {
    ...
    public void testServletMappingButNoAppPath() throws Exception {
        ...
        when(mockServletContext.addServlet(AppWithNoAppPath.class.getName(), HttpServlet30Dispatcher.class))
                .thenReturn(mockReg);
        when(mockReg.getInitParameter("resteasy.Application")).thenReturn(null);
        ...
        verify(mockReg).getInitParameter("resteasy.Application");
        ...
        verify(mockReg).setInitParameter("resteasy.Application", AppWithNoAppPath.class.getName());
    ...
    public void testAppWithAppPathNoWebXml() throws Exception {
        ...
        verify(mockReg).setInitParameter("resteasy.Application", AppWithAppPath.class.getName());
