...
public abstract class AbstractSecurityDomainSetup implements ServerSetupTask {
    ...
    protected static final Logger logger = LogManager.getLogger(AbstractSecurityDomainSetup.class.getName());
    ...
    protected static void applyUpdate(final ModelControllerClient client, final ModelNode update, final boolean allowFailure) throws Exception {
