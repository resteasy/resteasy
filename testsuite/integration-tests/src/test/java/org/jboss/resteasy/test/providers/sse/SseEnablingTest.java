...
public class SseEnablingTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(SseEnablingTest.class.getSimpleName());
      war.addClass(SseEnablingTestResource.class);
      return ReasteasyTestUtil.finishContainerPrepare(war, null, SseEnablingTestResource.class);
   }
