...
public class ReadDataSourceTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(ReadDataSourceTest.class.getSimpleName());
      return ReasteasyTestUtil.finishContainerPrepare(war, null, ReadDataSourceResource.class);
   }
