...
/**
 * A filter which injects a {@link TestBean} and a {@link UriInfo} resource. Both are added to an aborted JSON response.
 *
 * @author <a href="mailto:jperkins@redhat.com">James R. Perkins</a>
 */
@RequestScoped
public class InjectionFilter implements ContainerRequestFilter {
