 ...
 * @tpTestCaseDetails Tests @Consumes and @Produces annotations on stereotype. Test verifies that @Consumes
 * and @Produces media types are respected both on the resource class and the method.
