...
public class HttponlyCookieTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(HttponlyCookieTest.class.getSimpleName());
      return ReasteasyTestUtil.finishContainerPrepare(war, null, HttponlyCookieResource.class);
   }
