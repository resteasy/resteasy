...
@Provider
@Priority(100)
public class ApplicationInjectionFeatureFilter implements ContainerResponseFilter {

   private ApplicationInjectionApplicationParent application;

   public ApplicationInjectionFeatureFilter(final ApplicationInjectionApplicationParent application) {
