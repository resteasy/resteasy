...
public interface Rx2ObservableResource {
    ...
    @Stream
    public Observable<byte[]> getBytes() throws InterruptedException;
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Stream
    public Observable<byte[]> putBytes(String s) throws InterruptedException;
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Stream
    public Observable<byte[]> postBytes(String s) throws InterruptedException;
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Stream
    public Observable<byte[]> deleteBytes() throws InterruptedException;
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Stream
    public Observable<byte[]> optionsBytes() throws InterruptedException;
    ...
    @Produces(MediaType.APPLICATION_OCTET_STREAM)
    @Stream
    public Observable<byte[]> traceBytes() throws InterruptedException;
