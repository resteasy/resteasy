...
public class CookieInjectionTest {
   ...
   public static Archive<?> deploy() throws Exception {
      WebArchive war = ReasteasyTestUtil.prepareArchive(CookieInjectionTest.class.getSimpleName());
      return ReasteasyTestUtil.finishContainerPrepare(war, null, CookieInjectionResource.class);
   }
