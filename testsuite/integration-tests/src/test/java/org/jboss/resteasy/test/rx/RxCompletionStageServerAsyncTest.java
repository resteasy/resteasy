...
public class RxCompletionStageServerAsyncTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(RxCompletionStageServerAsyncTest.class.getSimpleName());
      ...
      return ReasteasyTestUtil.finishContainerPrepare(war, null, RxCompletionStageResourceImpl.class, TestExceptionMapper.class, ExceptionThrowingFilter.class);
   }
