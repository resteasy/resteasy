...
public class ProxyJaxbResourcePostTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(ProxyJaxbResourcePostTest.class.getSimpleName());
      war.addClass(ProxyJaxbResourcePostMessageIntf.class);
      return ReasteasyTestUtil.finishContainerPrepare(war, null, ProxyJaxbResourcePostMessage.class,
