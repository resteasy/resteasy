...
public class ClientWebApplicationExceptionResteasyProxyResource {
    ...
    static {
        ...
        oldBehaviorProxy = client
                .target(PortProviderUtil.generateURL("/app/test/",
                        ClientWebApplicationExceptionResteasyProxyTest.oldBehaviorDeploymentName))
                .proxy(ClientWebApplicationExceptionProxyResourceInterface.class);
        newBehaviorProxy = client
                .target(PortProviderUtil.generateURL("/app/test/",
                        ClientWebApplicationExceptionResteasyProxyTest.newBehaviorDeploymentName))
                .proxy(ClientWebApplicationExceptionProxyResourceInterface.class);
    }
