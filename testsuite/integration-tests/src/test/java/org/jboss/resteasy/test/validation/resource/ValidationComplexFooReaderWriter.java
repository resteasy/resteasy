...
public class ValidationComplexFooReaderWriter
        implements MessageBodyReader<ValidationComplexFoo>, MessageBodyWriter<ValidationComplexFoo> {
    public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return ValidationComplexFoo.class.equals(type);
    }

    public long getSize(ValidationComplexFoo t, Class<?> type, Type genericType, Annotation[] annotations,
            MediaType mediaType) {
        return -1;
    }
