...
public class WebTargetTest extends ClientTestBase {
     ...
     *              <li>Resolve "id" template, resolve "username" template, resolve again "id" template which should be
     *              ignored</li>
     *              <li>Resolve "username" template, create separate WebTarget instance, again resolve "username" template,
     *              resolve "id" twice</li>
     ...
     * @tpProcedure
     *              <ul>
     *              <li>Create WebTarget Instance from another base WebTarget instance, change the URI by calling
     *              matrixParam()</li>
