...
public class MultiValuedParamDefaultParamConverterValueOfClass
        implements Comparable<MultiValuedParamDefaultParamConverterValueOfClass> {
    private String s;
    ...
    static class Comp implements Comparator<MultiValuedParamDefaultParamConverterValueOfClass> {
        ...
        @Override
        public int compare(MultiValuedParamDefaultParamConverterValueOfClass o1,
                MultiValuedParamDefaultParamConverterValueOfClass o2) {
