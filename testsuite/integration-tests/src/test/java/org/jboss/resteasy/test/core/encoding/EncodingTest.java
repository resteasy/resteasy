...
public class EncodingTest {
    ...
    public void decodeWesternEuropeanCharsInPath() throws Exception {
        ...
        Assert.assertEquals("Wrong decoded path", "D\u00E6lenenga Gr\u00FCnerl\u00F8kka",
                Encode.decodePath("D%C3%A6lenenga%20Gr%C3%BCnerl%C3%B8kka"));
        Assert.assertEquals("Wrong decoded path", "\u00C4lv\u00E5s V\u00E4stra G\u00F6taland",
