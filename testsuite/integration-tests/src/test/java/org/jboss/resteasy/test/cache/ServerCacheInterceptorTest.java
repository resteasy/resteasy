...
public class ServerCacheInterceptorTest {
   ...
   public static Archive<?> deploySimpleResource() {
      ...
      WebArchive war = ReasteasyTestUtil.prepareArchive(ServerCacheInterceptorTest.class.getSimpleName());
      ...
      return ReasteasyTestUtil.finishContainerPrepare(war, null, singletons, ServerCacheInterceptorResource.class);
   }
