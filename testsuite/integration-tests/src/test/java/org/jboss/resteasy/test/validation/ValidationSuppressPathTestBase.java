...
public class ValidationSuppressPathTestBase {
   ...
   public void doTestInputViolations(String fieldPath, String propertyPath, String classPath, String... parameterPaths) throws Exception {
      ...
      Assert.assertNotNull(WRONG_ERROR_MSG, ReasteasyTestUtil.getViolationByPath(e.getPropertyViolations(), fieldPath));
      Assert.assertNotNull(WRONG_ERROR_MSG, ReasteasyTestUtil.getViolationByPath(e.getPropertyViolations(), propertyPath));
