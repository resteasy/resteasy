...
public class MultiValuedParamDefaultParamConverterHeaderDelegateClass
        implements Comparable<MultiValuedParamDefaultParamConverterHeaderDelegateClass> {
    private String s;
    ...
    static class Comp implements Comparator<MultiValuedParamDefaultParamConverterHeaderDelegateClass> {
        ...
        @Override
        public int compare(MultiValuedParamDefaultParamConverterHeaderDelegateClass o1,
                MultiValuedParamDefaultParamConverterHeaderDelegateClass o2) {
