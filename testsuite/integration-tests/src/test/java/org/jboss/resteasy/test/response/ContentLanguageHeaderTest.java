...
public class ContentLanguageHeaderTest {
   ...
   public static Archive<?> createTestArchive() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(ContentLanguageHeaderTest.class.getSimpleName());
      return ReasteasyTestUtil.finishContainerPrepare(war, null, ContentLanguageHeaderResource.class);
   }
