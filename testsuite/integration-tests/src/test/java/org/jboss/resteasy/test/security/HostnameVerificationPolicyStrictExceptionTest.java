...
@RunAsClient
public class HostnameVerificationPolicyStrictExceptionTest {

   protected static final Logger LOG = Logger.getLogger(HostnameVerificationPolicyStrictExceptionTest.class.getName());
   ...
   public static Archive<?> deployDefault() throws Exception {
      ...
      secureServer();
      WebArchive war = TestUtil.prepareArchive(HostnameVerificationPolicyStrictExceptionTest.class.getSimpleName());
   ...
   private String generateHttpsURL(String path) {
      return PortProviderUtil.generateHttpsURL(path, HostnameVerificationPolicyStrictExceptionTest.class.getSimpleName());
   }
   ...
   public void test() {
      ...
      client.target(generateHttpsURL("/secure/hello")).request().get();
   }
