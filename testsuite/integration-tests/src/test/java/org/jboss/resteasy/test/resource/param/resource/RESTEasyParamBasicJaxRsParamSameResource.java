...
public class RESTEasyParamBasicJaxRsParamSameResource
{
   ...
   public Response post(
         ...
         @jakarta.ws.rs.CookieParam("cookieParam3") String jaxrsCookieParam4,
         @jakarta.ws.rs.FormParam("formParam3") String jaxrsFormParam4,
         @jakarta.ws.rs.HeaderParam("headerParam3") String jaxrsHeaderParam4,
         @jakarta.ws.rs.MatrixParam("matrixParam3") String jaxrsMatrixParam4,
         @jakarta.ws.rs.PathParam("pathParam3") String jaxrsPathParam4,
         @jakarta.ws.rs.QueryParam("queryParam3") String jaxrsQueryParam4)
   {
