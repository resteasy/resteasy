...
public class Rx2FlowableExtTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = TestUtil.prepareArchive(Rx2FlowableExtTest.class.getSimpleName());
   ...
   private static String generateURL(String path) {
      return PortProviderUtil.generateURL(path, Rx2FlowableExtTest.class.getSimpleName());
   }
   ...
   public void testGet() throws Exception {
      ...
      Flowable<String> flowable = (Flowable<String>) response.getEntity();
      flowable.subscribe(
   ...
   public void testGetThing() throws Exception {
      ...
      Assert.assertEquals(200, response.getStatus());
      Assert.assertTrue(response.getMediaType().isCompatible(X_STREAM_GENERAL));
      Flowable<Thing> flowable = (Flowable<Thing>) response.getEntity();
      flowable.subscribe(
   ...
   public void testGetThingList() throws Exception {
      ...
      Assert.assertEquals(200, response.getStatus());
      Assert.assertTrue(response.getMediaType().isCompatible(X_STREAM_GENERAL));
      Flowable<List<Thing>> flowable = (Flowable<List<Thing>>) response.getEntity();
      flowable.subscribe(
   ...
   public void testGetBytes() throws Exception {
      ...
      Assert.assertEquals(200, response.getStatus());
      Assert.assertTrue(response.getMediaType().isCompatible(X_STREAM_GENERAL));
      Flowable<byte[]> flowable = (Flowable<byte[]>) response.getEntity();
      flowable.subscribe(
   ...
   public void testGetTwoClients() throws Exception {
      ...
      Flowable<String> flowable1 = (Flowable<String>) response1.getEntity();
      ...
      Flowable<String> flowable2 = (Flowable<String>) response2.getEntity();
