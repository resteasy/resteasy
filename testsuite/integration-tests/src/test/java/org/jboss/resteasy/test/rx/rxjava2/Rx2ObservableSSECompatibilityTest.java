...
public class Rx2ObservableSSECompatibilityTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(Rx2ObservableSSECompatibilityTest.class.getSimpleName());
      ...
      return ReasteasyTestUtil.finishContainerPrepare(war, null, Rx2ObservableSSECompatibilityResourceImpl.class);
   }
