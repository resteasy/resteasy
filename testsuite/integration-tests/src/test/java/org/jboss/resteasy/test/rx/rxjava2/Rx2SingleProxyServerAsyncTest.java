...
public class Rx2SingleProxyServerAsyncTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(Rx2SingleProxyServerAsyncTest.class.getSimpleName());
      ...
      return ReasteasyTestUtil.finishContainerPrepare(war, null, Rx2SingleResourceImpl.class, TestExceptionMapper.class);
   }
