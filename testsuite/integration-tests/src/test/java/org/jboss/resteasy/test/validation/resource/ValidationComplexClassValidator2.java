...
public class ValidationComplexClassValidator2 implements
        ConstraintValidator<ValidationComplexClassConstraint2, ValidationComplexResourceWithAllFivePotentialViolations> {
    public int length;
