...
public class FormEntityTest {
   ...
   public static Archive<?> createTestArchive() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(FormEntityTest.class.getSimpleName());
      return ReasteasyTestUtil.finishContainerPrepare(war, null, FormEntityResource.class);
   }
