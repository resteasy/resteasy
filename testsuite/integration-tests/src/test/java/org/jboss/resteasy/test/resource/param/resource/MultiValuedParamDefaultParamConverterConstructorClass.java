...
public class MultiValuedParamDefaultParamConverterConstructorClass
        implements Comparable<MultiValuedParamDefaultParamConverterConstructorClass> {
    ...
    static class Comp implements Comparator<MultiValuedParamDefaultParamConverterConstructorClass> {
        ...
        @Override
        public int compare(MultiValuedParamDefaultParamConverterConstructorClass o1,
                MultiValuedParamDefaultParamConverterConstructorClass o2) {
