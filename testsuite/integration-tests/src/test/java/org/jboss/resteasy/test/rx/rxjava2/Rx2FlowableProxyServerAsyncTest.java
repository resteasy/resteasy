...
public class Rx2FlowableProxyServerAsyncTest {
   ...
   public static Archive<?> deploy() {
      WebArchive war = ReasteasyTestUtil.prepareArchive(Rx2FlowableProxyServerAsyncTest.class.getSimpleName());
      ...
      return ReasteasyTestUtil.finishContainerPrepare(war, null, Rx2FlowableResourceNoStreamImpl.class, TestExceptionMapper.class);
   }
