...
public class ValidationJaxbTest {
    ...
    private void assertValidationReport(Response response) {
        ...
        MatcherAssert.assertThat(UNEXPECTED_VALIDATION_ERROR_MSG, jsonPath.getList("propertyViolations.constraintType"),
                Matchers.hasItem("PROPERTY"));
        MatcherAssert.assertThat(UNEXPECTED_VALIDATION_ERROR_MSG, jsonPath.getList("propertyViolations.path"),
                Matchers.hasItem("s"));
    }
}
