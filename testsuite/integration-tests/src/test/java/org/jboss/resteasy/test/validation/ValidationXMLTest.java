    ...
    protected void doTestJSON_pre(String mediaType) throws Exception {
        {
            ...
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("propertyViolations.value"),
                    Matchers.hasItems("a", "b"));
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("propertyViolations.message"),
            ...
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("classViolations.message"),
            ...
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("parameterViolations.path", String.class).get(0),
                    Matchers.startsWith("post."));
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("parameterViolations.message"),
                    Matchers.hasItem("s must have length: 3 <= length <= 5"));
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("parameterViolations.value"),
    ...
    protected void doTestJSON_post(String mediaType) throws Exception {
        {
            ...
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("returnValueViolations.constraintType"),
                    Matchers.hasItem("RETURN_VALUE"));
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("returnValueViolations.path"),
                    Matchers.hasItem("post.<return value>"));
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("returnValueViolations.message"),
                    Matchers.hasItem("s must have length: 4 <= length <= 5"));
            MatcherAssert.assertThat(WRONG_ERROR_MSG, jsonPath.getList("returnValueViolations.value"),
