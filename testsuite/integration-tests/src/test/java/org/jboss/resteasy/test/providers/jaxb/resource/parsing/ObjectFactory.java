...
public class ObjectFactory {
    ...
    private static final QName _DataCollectionPackage_QNAME = new QName("http://www.example.org/ParsingDataCollectionPackage",
            "ParsingDataCollectionPackage");
    private static final QName _DataCollectionRecord_QNAME = new QName("http://www.example.org/ParsingDataCollectionPackage",
    ...
    private static final QName _CollectedData_QNAME = new QName("http://www.example.org/ParsingDataCollectionPackage",
            "collectedData");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
     * mil.navy.tsts.datacollection.parseRS
     */
    ...
    public JAXBElement<ParsingDataCollectionPackage> createDataCollectionPackage(ParsingDataCollectionPackage value) {
        return new JAXBElement<ParsingDataCollectionPackage>(_DataCollectionPackage_QNAME, ParsingDataCollectionPackage.class,
                null, value);
    }
    ...
    public JAXBElement<ParsingDataCollectionRecord> createDataCollectionRecord(ParsingDataCollectionRecord value) {
        return new JAXBElement<ParsingDataCollectionRecord>(_DataCollectionRecord_QNAME, ParsingDataCollectionRecord.class,
                null, value);
    }
