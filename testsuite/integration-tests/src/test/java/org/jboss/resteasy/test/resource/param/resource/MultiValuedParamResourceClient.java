...
public interface MultiValuedParamResourceClient {
    ...
    interface PathParamResourceClient {
        ...
        String customConversion_multiValuedPathParam(@PathParam("path1") String path1, @PathParam("path2") String path2,
                @PathParam("path3") String path3);

        @GET
        @Path("customConversion_multiValuedPathParam_array/{path1}/{path2}/{path3}")
        String customConversion_multiValuedPathParam_array(@PathParam("path1") String path1, @PathParam("path2") String path2,
                @PathParam("path3") String path3);
