...
public class Digest256AuthenticationTest extends AbstractDigestAuthenticationTest {

    public Digest256AuthenticationTest() {
        super("SHA-256");
    }

    @Deployment
    public static WebArchive deployment() {
        return ShrinkWrap.create(WebArchive.class, Digest256AuthenticationTest.class.getSimpleName() + ".war")
                .addClasses(
