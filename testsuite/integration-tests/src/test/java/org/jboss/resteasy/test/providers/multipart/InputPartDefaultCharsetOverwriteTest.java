...
public class InputPartDefaultCharsetOverwriteTest {
    ...
    public static Archive<?> createTestArchiveContentTypeNoCharsetUTF8() {
        WebArchive war = TestUtil
                .prepareArchive(InputPartDefaultCharsetOverwriteContentTypeNoCharsetUTF8.class.getSimpleName());
        war.addClasses(InputPartDefaultCharsetOverwriteTest.class);
        war.addClasses(TestUtil.class, PortProviderUtil.class);
    ...
    public static Archive<?> createTestArchiveContentTypeNoCharsetUTF16() {
        WebArchive war = TestUtil
                .prepareArchive(InputPartDefaultCharsetOverwriteContentTypeNoCharsetUTF16.class.getSimpleName());
        war.addClasses(InputPartDefaultCharsetOverwriteTest.class);
        war.addClasses(TestUtil.class, PortProviderUtil.class);
    ...
    public static Archive<?> createTestArchiveNoContentTypeCharsetUTF8() {
        WebArchive war = TestUtil
                .prepareArchive(InputPartDefaultCharsetOverwriteNoContentTypeCharsetUTF8.class.getSimpleName());
        war.addClasses(InputPartDefaultCharsetOverwriteTest.class);
        war.addClasses(TestUtil.class, PortProviderUtil.class);
    ...
    public static Archive<?> createTestArchiveNoContentTypeCharsetUTF16() {
        WebArchive war = TestUtil
                .prepareArchive(InputPartDefaultCharsetOverwriteNoContentTypeCharsetUTF16.class.getSimpleName());
        war.addClasses(InputPartDefaultCharsetOverwriteTest.class);
        war.addClasses(TestUtil.class, PortProviderUtil.class);
    ...
    private static void doTestNoContentTypeInMessage(byte[] body, String expectedBody, String expectedContentType,
    ...
    private static void doTestWithContentTypeInMessage(byte[] body, String expectedBody, String inputContentType,
            String expectedContentType, Class<?> deployment) throws Exception {
