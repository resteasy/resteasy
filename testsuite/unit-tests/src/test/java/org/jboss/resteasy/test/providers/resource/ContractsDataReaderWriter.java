...
public class ContractsDataReaderWriter implements MessageBodyReader<ContractsData>, MessageBodyWriter<ContractsData> {
    ...
    @Override
    public ContractsData readFrom(Class<ContractsData> type, Type genericType, Annotation[] annotations, MediaType mediaType,
    ...
    @Override
    public void writeTo(ContractsData data, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
