...
public class AcceptParameterHttpPreprocessorTest {
    ...
    public void aLittleMoreComplicated() throws Exception {
        ...
        List<MediaType> expected = Arrays.asList(MediaType.TEXT_XML_TYPE, MediaType.TEXT_PLAIN_TYPE, MediaType.TEXT_HTML_TYPE,
    ...
    public void complex() throws Exception {
        ...
        String param1 = URLEncoder.encode("application/xml;q=0.9,application/xhtml+xml,*/*;q=0.8",
