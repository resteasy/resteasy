...
public class ObjectFactory {
    ...
    private static final QName _Comment_QNAME = new QName(
            "http://jboss.org/resteasy/test/providers/resource/jaxbNameSpacePrefix", "comment");
    private static final QName _PurchaseOrder_QNAME = new QName(
            "http://jboss.org/resteasy/test/providers/resource/jaxbNameSpacePrefix", "purchaseOrder");
    ...
    public JAXBElement<JaxbNameSpacePrefixPurchaseOrderType> createPurchaseOrder(JaxbNameSpacePrefixPurchaseOrderType value) {
        return new JAXBElement<JaxbNameSpacePrefixPurchaseOrderType>(_PurchaseOrder_QNAME,
                JaxbNameSpacePrefixPurchaseOrderType.class, null, value);
    }
