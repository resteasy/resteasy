...
/**
 * Test NewCookie6265 constructors
 */
public class NewCookie6265Test {
    ...
    public void testNewCookie6265() {
        ...
        NewCookie6265 c1b = new NewCookie6265("name", "value", "/path/", "domain", 3, true);
        NewCookie6265 c2b = new NewCookie6265("name", "value", "/path/", "domain", 3, true);
        Assert.assertTrue(c1b.equals(c2b));

        NewCookie6265 c1c = new NewCookie6265("name", "value", "/path/", "domain", 3, false, true);
        NewCookie6265 c2c = new NewCookie6265("name", "value", "/path/", "domain", 3, false, true);
        Assert.assertTrue(c1c.equals(c2c));

        NewCookie6265 c1e = new NewCookie6265("name", "value", "/path/", "domain", 3, new Date(1, 2, 3), true,
                false);
        NewCookie6265 c2e = new NewCookie6265("name", "value", "/path/", "domain", 3, new Date(1, 2, 3), true,
                false);
        Assert.assertTrue(c1e.equals(c2e));

        NewCookie6265 c1f = new NewCookie6265("name", "value", "/path/", "domain", 3, new Date(1, 2, 3), true, false,
                SameSite.LAX);
        NewCookie6265 c2f = new NewCookie6265("name", "value", "/path/", "domain", 3, new Date(1, 2, 3), true, false,
                SameSite.LAX);
