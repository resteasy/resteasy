...
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_bridge_runtime_sse___SseEvent;
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_example___CC2;
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_example___CC3;
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_example___CC4;
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_example___CC5;
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_example___CC7;
import jakarta.rest.example.CC1_proto.dev_resteasy_grpc_example___CC9;
...
public class GrpcToJakartaRESTTest2 {
    ...
    void testResponse(CC1ServiceBlockingStub stub) throws Exception {
        ...
        try {
            ...
            dev_resteasy_grpc_example___CC7 cc7 = dev_resteasy_grpc_example___CC7.newBuilder().setM(11).setCC3Super(cc3)
                    .build();
    ...
    void testSSE(CC1ServiceBlockingStub stub) throws Exception {
        ...
        ArrayList<dev_resteasy_grpc_bridge_runtime_sse___SseEvent> list = new ArrayList<dev_resteasy_grpc_bridge_runtime_sse___SseEvent>();
    ...
    void testInheritance(CC1ServiceBlockingStub stub) throws Exception {
        ...
        dev_resteasy_grpc_example___CC2 cc2 = dev_resteasy_grpc_example___CC2.newBuilder().setJ(17).setCC3Super(cc3).build();
        GeneralEntityMessage.Builder messageBuilder = GeneralEntityMessage.newBuilder();
    ...
    void testReferenceField(CC1ServiceBlockingStub stub) throws Exception {
        ...
        dev_resteasy_grpc_example___CC4 cc4 = dev_resteasy_grpc_example___CC4.newBuilder().setS("grog").setCc5(cc5).build();
        GeneralEntityMessage.Builder messageBuilder = GeneralEntityMessage.newBuilder();
    ...
    void testSseAsyncStub(CC1ServiceStub asyncStub) throws Exception {
        ...
        CountDownLatch latch = new CountDownLatch(1);
        GeneralReturnMessageHolder<dev_resteasy_grpc_bridge_runtime_sse___SseEvent> grmh = new GeneralReturnMessageHolder<dev_resteasy_grpc_bridge_runtime_sse___SseEvent>();
        StreamObserver<dev_resteasy_grpc_bridge_runtime_sse___SseEvent> responseObserver = new StreamObserver<dev_resteasy_grpc_bridge_runtime_sse___SseEvent>() {
            @Override
