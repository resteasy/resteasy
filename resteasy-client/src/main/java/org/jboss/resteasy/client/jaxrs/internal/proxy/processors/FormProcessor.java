...
public class FormProcessor implements InvocationProcessor, WebTargetProcessor
{
   ...
   public void process(ClientInvocationBuilderInterface invocation, Object param)
   {
      process(new Process()  {
         ...
         public Object process(Object target, Object value, Object processor)
         {
            processParam((ClientInvocationBuilderInterface)target, value, processor);
            return target;
         }
      }, invocation, param);
   }
   ...
   private void processParam(ClientInvocationBuilderInterface invocation, Object val, Object proc)
   {
