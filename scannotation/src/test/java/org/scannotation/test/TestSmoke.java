...
public class TestSmoke
{
   ...
   public void testFindClasspaths() throws Exception
   {
      ...
      {
         System.err.println("WARNING!!!!!!!! CANNOT TEST FIND CLASSPATHS:  This is a Maven2 and Surefire problem in that it doesn't set java.class.path correctly.  I run this test within the IDE");
      }
