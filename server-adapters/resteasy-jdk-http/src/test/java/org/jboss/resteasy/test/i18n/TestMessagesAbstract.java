...
abstract public class TestMessagesAbstract extends TestMessagesParent
{
   ...
   {  
      ...
      String filename = "org/jboss/resteasy/plugins/server/sun/http/resteasy_jdk_http/i18n/Messages.i18n_" + locale.toString() + ".properties";
      ...
      Assert.assertEquals(getExpected(BASE + "00", "errorParsingRequest"), Messages.MESSAGES.errorParsingRequest());
      Assert.assertEquals(getExpected(BASE + "05", "wtf"), Messages.MESSAGES.wtf());
   }
