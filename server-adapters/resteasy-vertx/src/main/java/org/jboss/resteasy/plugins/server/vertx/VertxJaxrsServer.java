...
//   private int executorThreadCount = 16;
   ...
   /**
    * Specify the worker count to use. For more information about this please see the javadocs of {@link VertxOptions#setEventLoopPoolSize(int)}
    *
    * @param ioWorkerCount
    */
   public void setIoWorkerCount(int ioWorkerCount)
   {
       vertxOptions.setEventLoopPoolSize(ioWorkerCount);
   }

   /**
    * Set the number of threads to use for the EventExecutor. For more information please see the javadocs of {@link VertxOptions#setWorkerPoolSize}.
    * If you want to disable the use of the {@link VertxOptions#setWorkerPoolSize} specify a value <= 0.  This should only be done if you are 100% sure that you don't have any blocking
    * code in there.
    *
   ...
   {
       vertxOptions.setWorkerPoolSize(executorThreadCount);
   }
    ...
    {
        serverOptions.setAcceptBacklog(backlog);
    }

    public int getIdleTimeout() {
        return serverOptions.getIdleTimeout();
    }
    ...
    public void setIdleTimeout(int idleTimeoutSeconds) {
        serverOptions.setIdleTimeout(idleTimeoutSeconds);
    }

    /**
     * Set Vert.x {@link io.vertx.core.http.HttpServerOptions}.
     *
