package org.jboss.resteasy.oath.i18n;
...
public interface Messages
{
   ...
   @Message(id = BASE + 185, value = "UTF8 encoding should be supported")
   String utf8EncodingShouldBeSupported();
   
   @Message(id = BASE + 190, value = "Wrong callback URI")
   String wrongCallbackURI();

   @Message(id = BASE + 195, value = "Wrong URI Scope")
