...
//        .append("import org.jboss.resteasy.plugins.grpc.sse.SseEvent;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.AsyncContextImpl;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.AsyncMockServletOutputStream;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.GrpcHttpServletDispatcher;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.HttpServletRequestImpl;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.HttpServletResponseImpl;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.MockServletInputStream;\n")
        .append("import org.jboss.resteasy.grpc.servlet.runtime.MockServletOutputStream;\n")
...
//           .append("         }\n");
   ...
   private void staticMethods(StringBuilder sb, String root, String pkg) {
      ...
      sb.append("   private static HttpServletRequest getHttpServletRequest(").append(pkg).append(".").append(root).append("_proto.GeneralEntityMessage param, GeneratedMessageV3 actualParam, String path, HttpServletResponse response, String verb, String type) throws Exception {\n")
        ...
        .append("      HttpServletRequestImpl request = CDI.current().select( HttpServletRequestImpl.class ).get();\n")
