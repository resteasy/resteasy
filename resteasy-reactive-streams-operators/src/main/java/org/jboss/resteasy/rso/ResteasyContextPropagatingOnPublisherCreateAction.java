...
public class ResteasyContextPropagatingOnPublisherCreateAction implements BiFunction<Publisher, Subscriber, Subscriber>
{

   @SuppressWarnings("unchecked")
   @Override
   public Subscriber apply(Publisher p, Subscriber t2) throws Exception
   {
